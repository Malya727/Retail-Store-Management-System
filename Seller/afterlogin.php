        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="afterlogin.php">All Items <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        ...
        ?>
				...
				<div class="card mx-auto col-mb-3 mt-4"  style="width: 18rem;">
					<img class="card-img-top" src="./<?php echo $row['Image']?>" height="300px" alt="Card image cap">
					<div class="card-body">
        ...
        <?php
            ...
            ?><img src="./IMAGE/sadface.png" height="150px" alt=""><br /> Oops! No Items Found<br /><?php
            }
            ?>
