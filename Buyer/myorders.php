...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="container">
            ...
            $uuid = $_SESSION['id'];
                ...
                if (empty($date)) {
                $query = "SELECT * FROM orders WHERE Uid = '$uuid' ";
            ...
            {
                ?><br/><h1 class="mt-4" style="text-align: center;margin-top: 50px;">No Orders Found</h1><?php
            }
        }
        else{
            $query = "SELECT * FROM orders WHERE Date = '$date' AND Uid = '$uuid'";
            $result = mysqli_query($conn, $query);
            if (mysqli_num_rows($result) > 0) {
                $count = 0;
            ?>
